...
[DependsOn(
    typeof(UserProfileApplicationTestModule),
    typeof(UserProfileEntityFrameworkCoreModule),
    typeof(AbpEntityFrameworkCoreSqliteModule)
    )]
public class UserProfileEntityFrameworkCoreTestModule : AbpModule
{
    ...
    private static SqliteConnection CreateDatabaseAndGetConnection()
    {
        ...
        using (var context = new UserProfileDbContext(options))
        {
