...
public class UserProfileDbContext :
    AbpDbContext<UserProfileDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    /* Add DbSet properties for your Aggregate Roots / Entities here. */
    public DbSet<UserProfiles.UserProfile> UserProfiles { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.Entity<UserProfiles.UserProfile>(b =>
        {
            b.ToTable(UserProfileConsts.DbTablePrefix + "UserProfiles", UserProfileConsts.DbSchema);
            // ABP auto-configures FullAuditedAggregateRoot properties
            
            b.Property(x => x.ExternalUserId).IsRequired().HasMaxLength(200);
            b.Property(x => x.Email).IsRequired().HasMaxLength(200);
            b.Property(x => x.FullName).IsRequired().HasMaxLength(200);
            b.Property(x => x.PrimaryRole).HasMaxLength(200);
            b.Property(x => x.AssignedClients).HasMaxLength(500);
