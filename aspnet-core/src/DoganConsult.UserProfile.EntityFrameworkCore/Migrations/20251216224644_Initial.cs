...
namespace DoganConsult.UserProfile.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrimaryRole = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    OrganizationId = table.Column<Guid>(type: "uuid", nullable: false),
                    AssignedClients = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppUserProfiles_ExternalUserId",
                table: "AppUserProfiles",
                column: "ExternalUserId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AppUserProfiles_OrganizationId",
                table: "AppUserProfiles",
