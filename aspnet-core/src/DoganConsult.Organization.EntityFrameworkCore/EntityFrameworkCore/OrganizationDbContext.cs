...
public class OrganizationDbContext :
    AbpDbContext<OrganizationDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        {
            b.ToTable(OrganizationConsts.DbTablePrefix + "Organizations", OrganizationConsts.DbSchema);
            ...
            b.Property(x => x.Regulators).HasMaxLength(500);
            b.Property(x => x.Status).HasMaxLength(20);
            b.Property(x => x.PrimaryContactEmail).HasMaxLength(200);
