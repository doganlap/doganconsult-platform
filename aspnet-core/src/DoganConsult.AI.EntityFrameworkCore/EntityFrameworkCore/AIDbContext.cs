    ...
    ITenantManagementDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        {
            b.ToTable(AIConsts.DbTablePrefix + "AIRequests", AIConsts.DbSchema);
            // ABP auto-configures FullAuditedAggregateRoot properties
            
            b.Property(x => x.RequestType).IsRequired().HasMaxLength(200);
            b.Property(x => x.InputText).HasMaxLength(2000);
            b.Property(x => x.ResponseText).HasMaxLength(10000);
