...
namespace DoganConsult.AI.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InputText = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                    ResponseText = table.Column<string>(type: "character varying(10000)", maxLength: 10000, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppAIRequests", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppAIRequests_CreationTime",
                table: "AppAIRequests",
                column: "CreationTime");

            migrationBuilder.CreateIndex(
                name: "IX_AppAIRequests_OrganizationId",
                table: "AppAIRequests",
                column: "OrganizationId");

            migrationBuilder.CreateIndex(
                name: "IX_AppAIRequests_RequestType",
                table: "AppAIRequests",
                column: "RequestType");
