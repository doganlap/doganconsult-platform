...
/// <summary>
/// Global exception handler middleware for all microservices
/// Handles ABP Framework exceptions and provides standardized error responses
/// </summary>
public class GlobalExceptionHandlerMiddleware
{
    ...
    private static Task HandleExceptionAsync(HttpContext context, Exception exception)
    {
        ...
        // If needed, add: using Volo.Abp.Domain.Entities;
